...
func genericDrawCursor(list *entry) {
	...
	menu.Draw(menu.White,
		...
		float32(w)-630*menu.ratio, 100*menu.ratio, 1, 1, cursorBgColor.Alpha(list.cursor.alpha))
}
...
func thumbnailDrawCursor(list *entry) {
	...
	menu.Draw(menu.White,
		...
		float32(w)-630*menu.ratio, 240*menu.ratio, 1, 0.2, cursorBgColor.Alpha(list.cursor.alpha))
}

...
func TestDB_Find(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			tt.db.Find(tt.args.romPath, tt.args.romName, tt.args.CRC32, tt.args.games)
		})
	}
}

...
// draws with the core aspect ratio and returns the pixel bounds to read back.
...
// CaptureFrameImage returns the current frame as an image.
func (video *Video) CaptureFrameImage() (image.Image, error) {
	return video.captureFrameImage()
}

...
var lightTheme = map[string]Color{
	...
	"hintbar-secondary": {R: 0.25, G: 0.25, B: 0.25, A: 1},
	"grey":              {R: 0.5, G: 0.5, B: 0.5, A: 1},
	"hintbar":           {R: 0.75, G: 0.75, B: 0.75, A: 1},
...
var darkTheme = map[string]Color{
	...
	"hintbar-secondary": {R: 0.75, G: 0.75, B: 0.75, A: 1},
	"grey":              {R: 0.5, G: 0.5, B: 0.5, A: 1},
	"hintbar":           {R: 0.25, G: 0.25, B: 0.25, A: 1},
...
// GetHclColor return default color setup by theme mode
func GetHclColor() float64 {
	if settings.Current.VideoDarkMode {
		return 180
	}
	return 0

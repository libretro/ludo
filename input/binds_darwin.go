...
var ds4JoyBinds = joybinds{
	...
	bind{axis, 10, 1, 0.5}: libretro.DeviceIDJoypadL3,
	bind{axis, 11, 1, 0.5}: libretro.DeviceIDJoypadR3,
...
var ds3JoyBinds = joybinds{
	...
	bind{axis, 1, 1, 0.5}: libretro.DeviceIDJoypadL3,
	bind{axis, 2, 1, 0.5}: libretro.DeviceIDJoypadR3,
